...
The decision-support workflow is currently running in demonstration mode.
...
Note: This demonstration uses prepared sample insights when live AI services are temporarily unavailable.`,
    "ai-message"
);
        }
        ...
        addMessage(
            "⚠️ AI server connection failed. Please start the NeuroNexora backend.",
            "ai-message"
        );
